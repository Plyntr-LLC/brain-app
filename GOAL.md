...
- [x] 2026-09-26 Joe: Brand-new Mac still stuck on Cloudflare Tunnel. Terminal opened, Homebrew errored, Process completed, tunnel missing. Mac setup now downloads Cloudflare’s official binary into Brain’s own folder. No Homebrew, no Terminal, no password. Phone uses the same binary. Done: 2026-09-26. Evidence: Brain.app 0.1.70. Opus 5.5 medium REJECT on the first pass (broken phone import); timeout, shared lookup test, and that import are in this build.
