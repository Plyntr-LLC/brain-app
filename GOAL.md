...
- [x] 2026-09-19 Joe: Invite mail and the /install page send people to Brain.app, not the old Brain Bridge zip. Done: 2026-09-19. Grok 4.6 xhigh APPROVE (cycle 2). Worker deployed. Evidence: `inviteMail` Download Brain; `installPage` → brain-app releases/latest.
- [ ] 2026-09-19 Joe: Connect HQ from the watched folder. Open the Brain Bridge GitHub App if needed, wait until GitHub is done, then bind. First-run waits the same way for Agency Brain Sync.
