...
- Mac one-file installer: `npm run pack:mac` writes a signed arm64 dmg. Latest packed: **0.1.53**. Developer ID Application: Plyntr LLC. Setup installs Brain Bridge on both routes, and the CLI checkboxes sit next to their names.
