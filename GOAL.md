...
- Mac one-file installer: `npm run pack:mac` writes a signed arm64 dmg. Latest packed: **0.1.57**. Developer ID Application: Plyntr LLC. Revoke asks before it removes access. A revoked person can be invited again.
