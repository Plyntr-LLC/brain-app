...
- Mac one-file installer: `npm run pack:mac` writes a signed arm64 dmg. Latest packed: **0.1.51**. Next unsigned tree is 0.1.52 (Path B install URL). Do not pack until Grok 4.7 and Opus 5.5 APPROVE. Developer ID Application: Plyntr LLC.
