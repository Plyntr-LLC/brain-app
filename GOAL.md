...
- Mac one-file installer: `npm run pack:mac` writes a signed arm64 dmg. Latest packed: **0.1.54**. Developer ID Application: Plyntr LLC. Add users can mint Owner, Scout, Team, and Project only. Team is the seat name.
